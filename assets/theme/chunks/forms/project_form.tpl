<form class="form modal__form" action="{$_modx->resource.id | url}" method="post" data-policy-form>
    ...
    <button class="form__submit btn btn-reset _blue" type="submit" data-policy-submit>Оставить заявку</button>

    <div class="form__checkbox">
        <input class="form__checkbox-input" type="checkbox" name="privacy_policy" id="policy-project-modal" data-policy>

        <label class="form__checkbox-label" for="policy-project-modal">
