<div class="modal" id="modal-question" data-lenis-prevent>
    <div class="modal__content radius-20">
        ...
        <h3 class="modal__title">{'question_form_title' | config}</h3>

        {'!FetchIt' | snippet : [
            'form' => '@FILE:chunks/forms/question_form.tpl',
            'validate' => 'name:required,phone:required,info:blank',
            'hooks' => 'spam,email,FormItSaveForm',
            'emailTpl' => '@FILE:chunks/forms/email.tpl',
            'submitVar' => 'question',
            'emailSubject' => 'Вопрос по вакансии с сайта ' ~ 'site_name' | config,
            'emailTo' => 'email_form' | config,
            'emailFrom' => 'emailsender' | config,
            'emailFromName' => 'site_name' | config,
            'formName' => 'Вопрос по вакансии',
