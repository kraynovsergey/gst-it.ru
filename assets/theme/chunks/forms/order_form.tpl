<form class="form modal__form" action="{$_modx->resource.id | url}" method="post" data-policy-form>
    ...
    <div class="form__checkbox">
        <input class="form__checkbox-input" type="checkbox" name="privacy_policy" id="footer-form-modal" data-policy>

        <label class="form__checkbox-label" for="footer-form-modal">
